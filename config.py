...
class Config(object):
    ...
    SQL_USER_NAME = os.environ.get('SQL_USER_NAME') or 'admin12345'
    # SQL_PASSWORD = os.environ.get('SQL_PASSWORD') or 'Test12345@'
    # Below URI may need some adjustments for driver version, based on your OS, if running locally
    SQL_PASSWORD = quote(os.environ.get('SQL_PASSWORD') or 'Test12345@')
